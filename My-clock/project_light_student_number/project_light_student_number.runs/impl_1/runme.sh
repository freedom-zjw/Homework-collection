...
HD_PWD='D:/Xilinx/workplace/project_light_student_number/project_light_student_number.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lightstudentnum.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lightstudentnum.tcl -notrace
