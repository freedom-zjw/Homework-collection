...
HD_PWD='D:/Xilinx/workplace/project_light_student_number/project_light_student_number.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lightstudentnum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lightstudentnum.tcl
