...
HD_PWD='D:/Xilinx/workplace/myclock/myclock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myclock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myclock.tcl
