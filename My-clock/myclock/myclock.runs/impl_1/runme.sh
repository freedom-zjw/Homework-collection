...
HD_PWD='D:/Xilinx/workplace/myclock/myclock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myclock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myclock.tcl -notrace
