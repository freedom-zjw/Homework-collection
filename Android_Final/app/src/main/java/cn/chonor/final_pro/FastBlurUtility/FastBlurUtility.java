package cn.chonor.final_pro.FastBlurUtility;
...
public class FastBlurUtility {
    ...
    public static Bitmap getBlurBackgroundDrawer(Activity activity) {
        ...
        return startBlurBackground(bmp,0);//返回清晰原图
    }
    ...
    public static Bitmap startBlurBackground(Bitmap bkg , int rad) {
