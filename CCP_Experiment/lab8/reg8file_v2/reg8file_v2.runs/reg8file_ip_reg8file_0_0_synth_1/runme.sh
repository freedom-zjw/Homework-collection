...
HD_PWD='D:/大学/大二/大二下/计算机组成原理/实验/第8次/reg8file_v2/reg8file_v2.runs/reg8file_ip_reg8file_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reg8file_ip_reg8file_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reg8file_ip_reg8file_0_0.tcl
